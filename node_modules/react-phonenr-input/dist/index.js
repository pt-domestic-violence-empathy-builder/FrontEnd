...
function (_Component) {
  ...
  _createClass(PhoneInput, [{
    ...
    value: function componentDidMount() {
      ...
      if (initialValue) {
        var tel = initialValue.startsWith('+') ? initialValue.slice(1, 4) : initialValue.slice(0, 3);
        this.setState(function (prevState) {
          return {
            country: format === 'INTERNATIONAL' && getCountry(tel) || prevState.country,
            phoneNumber: _this2.formatNumber(initialValue)
          };
        }, function () {
          return _this2.handleReturnValue();
        });
      }
    }
  }, {
    ...
    value: function render() {
      ...
      var _this$props4 = this.props,
          ...
          preferredCountries = _this$props4.preferredCountries,
          regions = _this$props4.regions,
          format = _this$props4.format,
          className = _this$props4.className,
          listFlagStyles = _this$props4.listFlagStyles;
      var passableProps = lodash_omit(this.props, ['format', 'regions', 'defaultCountry', 'preferredCountries', 'buttonFlagStyles', 'listFlagStyles', 'withCountryMeta', 'initialValue']);
      ...
      return React.createElement("div", {
        ...
        return React.createElement("li", {
          key: c.iso2,
          onClick: _this3.handleSelect(c.iso2),
          onKeyPress: _this3.handleSelect(c.iso2),
          className: classnames('country-list-item', {
            'active-country': c.iso2 === iso2
          }),
          ref: c.iso2 === iso2 ? _this3.activeCountry : null
        }, React.createElement(ReactCountryFlag, {
          styleProps: _objectSpread2({
            width: '20px'
          }, listFlagStyles),
